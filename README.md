...
Not sure? **Six presets** set every switch in one tap — start with 🌱 Vanilla, or ⚰️ Veterans if you want walls to actually cost you something.
...
- **Six presets** plus seven optional dials: level cap, random succession, tour length, bloodline
