...
- **Tours, tracked for you** — rollable from the Overview card *and* from any Pokémon's own card, where the number can also be re-rolled if you mis-tapped the die. Every Pokémon rolls its tour on the die screen the moment it takes a chair, and its card shows the majors it has left (📜 3, 📜 2…). Beat a major and every tour ticks down automatically.
