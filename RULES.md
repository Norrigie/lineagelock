...
- **Where each wall is** — every one of the **527 bundled majors** names the place it happens: the town, gym, cave or route, on the Next Major card and on every row of the checklist. Decay's 56 were read out of the game's own map files, since its dev sheet records levels but not places.
