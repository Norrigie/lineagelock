...
- **How each Pokémon evolves** — the card lists what it can become and **how**, for the game you are playing. The method is per game, because it genuinely differs: Machoke is a trade in the mainline, a **Switchstone** in Decay and an **Update Mega** in Xenoverse; Jolteon is a Thunder Stone everywhere except Decay, where you raise friendship in a **Voltage area**. Methods that postdate a game are not offered — Red · Blue never mentions friendship, because friendship did not exist — and where the national dex records several, they are shown with *or*, since PokéAPI merges a regional form into its base line and Alolan Sandshrew really does take an Ice Stone.
